...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            await interaction.reply({ content: 'Starting server setup...', ephemeral: true });
            ...
            await interaction.followUp({ content: 'Please provide a name for the admin role or type "default" for the default admin role name: "Admin".', ephemeral: true });
            ...
            await interaction.followUp({ content: 'Please provide a comma-separated list of subjects to create roles and channels (e.g., "Math, Science, English").', ephemeral: true });
